...
export const sendBookingConfirmationEmail = async (booking, room) => {
  ...
  const htmlContent = `
    ...
    <body>
      <div class="container">
        <div class="header">
          <div class="logo">Kabsat La Union</div>
        </div>
        ...
        <div class="content">
          ...
          <p>Thank you for choosing Kabsat La Union. We are delighted to confirm your reservation.</p>
          ...
          <div class="contact">
            ...
            <p>Email: reservations@kabsatlaunion.com</p>
            <p>Website: kabsatlaunion.com</p>
          </div>
        </div>
        
        <div class="footer">
          <p>Kabsat La Union</p>
          <p>San Juan, La Union, San Juan, Philippines, 2514</p>
          <p>&copy; ${new Date().getFullYear()} Kabsat La Union. All rights reserved.</p>
        </div>
      </div>
    </body>
    </html>
  ...
  const mailOptions = {
    from:
      process.env.EMAIL_FROM || '"Kabsat La Union" <noreply@kabsatlaunion.com>',
    to: booking.email,
...
export const sendNewBookingNotification = async (booking, room) => {
  ...
  const mailOptions = {
    from:
      ...
      '"Kabsat La Union System" <noreply@kabsatlaunion.com>',
...
export const sendReceiptEmail = async (booking, room, pdfData) => {
  ...
  const htmlContent = `
    ...
    <body>
      <div class="container">
        <div class="header">
          <h1 class="logo">Kabsat La Union</h1>
          <p class="tagline">Surf & Beach Resort • La Union, Philippines</p>
        </div>
        
        <div class="content">
          <h2 class="title">Booking Confirmation</h2>
          <p class="subtitle">Thank you for choosing Kabsat La Union, ${booking.guestName}</p>
  ...
  const mailOptions = {
    from:
      process.env.EMAIL_FROM || '"Kabsat La Union" <noreply@kabsatlaunion.com>',
    to: booking.email,
    subject: `Booking Confirmation – ${booking.bookingReference} | Kabsat La Union`,
    html: htmlContent,
    attachments: [
      {
