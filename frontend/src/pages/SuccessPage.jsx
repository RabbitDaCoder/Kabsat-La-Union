      ...
      <div className="container-luxury max-w-4xl">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-ocean-600 max-w-md mx-auto">
            Thank you for choosing Kabsat La Union. Your booking confirmation
            and receipt have been prepared below.
          </p>
        </div>
        ...
        <div
          className={`
            ...
            ${emailSent ? "bg-green-50 text-green-700 border border-green-200" : "bg-ocean-100 text-ocean-600"}
          `}
        >
          {isSendingEmail ? (
            <>
        ...
        <div className="mt-12 text-center">
          <p className="text-ocean-600 mb-2">
            Need to modify your reservation?
          </p>
          <p className="text-ocean-950">
            Contact us at{" "}
            <a
              href="mailto:reservations@kabsatlaunion.com"
              className="underline hover:text-ocean-700"
            >
              reservations@kabsatlaunion.com
            </a>
          </p>
        </div>
      </div>
