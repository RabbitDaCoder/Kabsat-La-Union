      ...
      <section className="relative h-[50vh] min-h-[400px]">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center px-4">
          ...
          <p className="text-white/80 max-w-xl">
            Choose from our collection of luxurious rooms and bungalows in La
            Union, each offering unparalleled comfort and relaxation.
          </p>
        </div>
      </section>

      {/* Filters Section */}
      <section className="border-b border-ocean-200 bg-white sticky top-20 z-40">
        ...
        <div className="container-luxury">
          {isLoading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[...Array(6)].map((_, i) => (
                <div key={i} className="animate-pulse">
                  <div className="h-64 bg-ocean-200 rounded-lg mb-4" />
                  <div className="h-6 bg-ocean-200 rounded w-3/4 mb-2" />
            ...
            <div className="text-center py-16">
              <h3 className="font-serif text-2xl text-ocean-950 mb-4">
                ...
                >
                  <div className="relative h-64 overflow-hidden">
                    ...
                    {room.hasActiveDiscount && (
                      <Badge className="absolute top-4 right-4 bg-coral-500 hover:bg-coral-600">
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="flex items-center text-ocean-500 text-sm mb-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        {room.hasActiveDiscount && (
                          <span className="text-ocean-400 line-through text-sm mr-2">
                            {formatCurrency(room.price)}
                          </span>
                        )}
                        <span className="text-ocean-950 font-semibold text-lg">
