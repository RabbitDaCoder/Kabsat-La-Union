  ...
  return (
    <div className="min-h-screen bg-ocean-50 py-12">
      <div className="container-luxury">
        <button
          onClick={() => navigate(-1)}
          className="flex items-center text-ocean-600 hover:text-ocean-950 mb-8 transition-colors"
        >
          <ChevronLeft className="h-4 w-4 mr-1" />
          Back
        </button>

        <h1 className="font-serif text-3xl md:text-4xl text-ocean-950 mb-8">
          {bookingCreated
          ...
          <div className="lg:col-span-2 space-y-8">
            {!bookingCreated ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="md:col-span-2">
                        ...
                        <textarea
                          ...
                          className="w-full min-h-[100px] rounded-md border border-ocean-300 bg-white px-3 py-2 text-sm placeholder:text-ocean-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ocean-400"
                        />
                      </div>
                    </div>
                    <Button
              ...
              <>
                ...
                <Card className="border-coral-300 bg-coral-50/30">
                  <CardHeader>
                    ...
                    <CardDescription>
                      ...
                      <span className="font-mono font-bold text-ocean-950">
                        {bookingReference}
                      </span>
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="bg-white p-4 rounded-lg border border-coral-200">
                      <h4 className="font-medium text-ocean-950 mb-2">
                        To Complete Your Reservation:
                      </h4>
                      <ol className="list-decimal list-inside space-y-2 text-ocean-600">
                        <li>
                    ...
                    <Button
                      variant="outline"
                      className="w-full border-coral-400 text-coral-700 hover:bg-coral-100"
                      onClick={() => {
                        // Open Smartsupp chat
                        if (window.smartsupp) {
            ...
            <Card className="sticky top-24">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <h3 className="font-serif text-xl text-ocean-950">
                    {selectedRoom.name}
                  </h3>
                </div>
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    <span className="text-ocean-600">Check-in</span>
                    <span className="font-medium">
                      {format(new Date(checkIn), "MMM d, yyyy")}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-ocean-600">Check-out</span>
                    <span className="font-medium">
                      {format(new Date(checkOut), "MMM d, yyyy")}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-ocean-600">Guests</span>
                    <span className="font-medium">
