    ...
    <div className="min-h-screen bg-ocean-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          />
          <h1 className="font-serif text-3xl tracking-[0.1em] text-ocean-950 mb-2">
            KABSAT LA UNION
          </h1>
          <p className="text-ocean-500 text-sm uppercase tracking-wider">
            Surf & Beach Resort
          </p>
        </div>
        ...
        <Card>
          <CardContent className="p-8">
            <div className="text-center mb-8">
              ...
              <h2 className="font-serif text-2xl text-ocean-950 mb-2">
                Sign In
              </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Mail className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-ocean-400" />
                  <Input
                    id="email"
                    name="email"
                    type="email"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-ocean-400" />
                  <Input
                    id="password"
                    name="password"
