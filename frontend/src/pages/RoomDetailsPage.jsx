  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-ocean-950" />
      </div>
    );
  }
      ...
      <section className="relative bg-black">
        ...
        <div className="relative h-[60vh] min-h-[400px]">
          ...
          {room.hasActiveDiscount && (
            <Badge className="absolute top-4 right-4 bg-coral-500 hover:bg-coral-600 text-base px-4 py-1">
        ...
        {/* Thumbnail Gallery */}
        {room.images?.length > 1 && (
          <div className="bg-ocean-900/90 px-4 py-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <button
              ...
              className="flex items-center text-ocean-600 hover:text-ocean-950 mb-6 transition-colors"
            >
            ...
            <h1 className="font-serif text-4xl text-ocean-950 mb-4">
              {room.name}
            </h1>

            <div className="flex items-center text-ocean-600 mb-6">
            ...
            {/* Amenities */}
            <div>
              <h2 className="font-serif text-2xl text-ocean-950 mb-6">
                Amenities
              </h2>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {room.amenities?.map((amenity, index) => (
                  <div key={index} className="flex items-center text-ocean-600">
            ...
            <Card className="sticky top-24">
              <CardHeader>
                <CardTitle className="flex items-center justify-between">
                  <div>
                    {room.hasActiveDiscount && (
                      <span className="text-ocean-400 line-through text-lg mr-2 font-normal">
                    ...
                    <span className="text-ocean-500 text-base font-normal">
                      {" "}
                      / night
                    </span>
                  </div>
              ...
              <CardContent className="space-y-6">
                {/* Date Selection */}
                <div>
                  <label className="text-sm font-medium text-ocean-700 mb-2 block">
                    Select Dates
                  </label>
                  <Popover>
                ...
                {/* Guest Selection */}
                <div>
                  <label className="text-sm font-medium text-ocean-700 mb-4 block">
                    Guests (Max {room.maxGuests})
                  </label>

                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="text-ocean-600">Adults</span>
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-ocean-600">Children</span>
                      <div className="flex items-center gap-3">
                        <Button
                          variant="outline"
                          size="icon"
                ...
                {nights > 0 && (
                  <div className="space-y-2">
                    ...
                    <Separator />
                    <div className="flex justify-between font-semibold text-ocean-950">
                      <span>Total</span>
                      <span>{formatCurrency(totalPrice)}</span>
                    </div>
                  </div>
