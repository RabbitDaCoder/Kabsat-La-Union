  ...
  return (
    <div className="p-6 lg:p-8">
      <div className="mb-8">
        ...
        <p className="text-ocean-600">View and manage all reservations</p>
      </div>
                          ...
                          {selectedBooking && (
                            <div className="space-y-4 py-4">
                              <div className="grid grid-cols-2 gap-4 text-sm">
                                <div>
                                  <p className="text-ocean-500">Guest Name</p>
                                  <p className="font-medium">
                                    {selectedBooking.guestName}
                                  </p>
                                </div>
                                <div>
                                  <p className="text-ocean-500">Email</p>
                                  <p className="font-medium">
                                    {selectedBooking.email}
                                  </p>
                                </div>
                                <div>
                                  <p className="text-ocean-500">Room</p>
                                  <p className="font-medium">
                                    {selectedBooking.roomId?.name}
                                  </p>
                                </div>
                                <div>
                                  <p className="text-ocean-500">Check-in</p>
                                  <p className="font-medium">
                                    {format(
                                ...
                                <div>
                                  <p className="text-ocean-500">Check-out</p>
                                  <p className="font-medium">
                                    {format(
                                ...
                                <div>
                                  <p className="text-ocean-500">Guests</p>
                                  <p className="font-medium">
                                ...
                                <div>
                                  <p className="text-ocean-500">Total Amount</p>
                                  <p className="font-medium">
                                    {formatCurrency(
                                ...
                                <div className="col-span-2">
                                  <p className="text-ocean-500">Status</p>
                                  {getStatusBadge(
                                ...
                                {selectedBooking.verificationCode && (
                                  <div className="col-span-2 p-4 bg-amber-50 rounded-lg">
                                    <p className="text-ocean-500 text-xs mb-1">
      ...
      {pagination.pages > 1 && (
        <div className="flex justify-center gap-2 mt-6">
          ...
          <span className="flex items-center px-4 text-ocean-600">
