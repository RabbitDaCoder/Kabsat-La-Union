...
export function AdminDashboardPage() {
  ...
  return (
    <div className="p-6 lg:p-8">
      <div className="mb-8">
        <h1 className="font-serif text-3xl text-ocean-950 mb-2">Dashboard</h1>
        <p className="text-ocean-600">
          Welcome back to Kabsat La Union admin portal
        </p>
      </div>
          ...
          ? [...Array(4)].map((_, i) => (
              <Card key={i} className="animate-pulse">
                <CardContent className="p-6">
                  <div className="h-12 bg-ocean-100 rounded mb-4" />
                  <div className="h-8 bg-ocean-100 rounded w-1/2" />
                </CardContent>
              </Card>
            ))
              ...
              return (
                <Card key={index}>
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-2xl font-bold text-ocean-950 mb-1">
                      {stat.value}
                    </h3>
                    <p className="text-sm text-ocean-600">{stat.title}</p>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a
              href="/owner/rooms"
              className="block p-4 rounded-lg border border-ocean-200 hover:border-ocean-400 transition-colors"
            >
              <h4 className="font-medium text-ocean-950 mb-1">Manage Rooms</h4>
            ...
            <a
              ...
              className="block p-4 rounded-lg border border-ocean-200 hover:border-ocean-400 transition-colors"
            >
              <h4 className="font-medium text-ocean-950 mb-1">View Bookings</h4>
              <p className="text-sm text-ocean-600">
